...
;---------------------------------------------------------------------------------------------------------------
METHOD Person, Init, age:BYTE, consoleHandle:QWORD, ptrName:QWORD
...
MainCRTStartup PROC 
    ...
    mov person1, _NEW(Person, 30, hOutput, "Jane Doe ")
    mov person2, _NEW(Person, 40, hOutput, "Peter Smith ")
    ...
    _INVOKE Person, SetName, person1, "Michael Smith "
